...
<head>
  ...
  <meta charset="utf-8">
  <title>รายชื่อหนังสือจากการค้นหา</title>
      ...
      <div class="col-md-10">
        <div class="row">
          ...
          <div class="col-xs-6 col-md-10">
            @if($_GET["txtKeyword"]=="")
              <center><strong><h1>Show All List</h1></strong></center>
            @else
              <center><strong><h1>Search : {{$_GET["txtKeyword"]}}</h1></strong></center>
            @endif
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-xs-12 col-md-12">
                      ...
                      <table class="table table-bordered">
                          <tr class="warning">
                            ...
                            <th width="100"> <div align="center">Delete
                          ...
                          <tr>
                            ...
                            <td><a href="edit_book?BookID={{$Book[$i]->id}}">{{$Book[$i]->Title1}}</a></td>
                            <td>{{$Book[$i]->Title2}}</td>
                            <td>{{$Book[$i]->ISBN}}</td>
                    ...
                    <nav>
                      ...
                      <?php
                      if($Prev_Page){
                        echo " <li><a href='search_book_list?Page=$Prev_Page&txtKeyword=$_GET[txtKeyword]'><< Back</a></li> ";
                      }
                      for($i=1; $i<=$Num_Pages; $i++){
                        if($i != $Page){
                          echo "<li><a href='search_book_list?Page=$i&txtKeyword=$_GET[txtKeyword]'>$i</a></li>";
                        }else{
                          echo "<li class='active'><a><b> $i </b></a></li>";
                        }
                      }
                      if($Page!=$Num_Pages){
                        echo " <li><a href ='search_book_list?Page=$Next_Page&txtKeyword=$_GET[txtKeyword]'>Next>></a></li> ";
                      }
                      ?>
                      </ul>
                    </nav>
