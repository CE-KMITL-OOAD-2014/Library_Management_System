...
<html lang="en">
        ...
        <div class="row">
          ...
          <div class="col-xs-8">
            <center><strong><h1>แก้ไขข้อมูลสมาชิกผู้ใช้งาน</h1></strong></center>
              <form action="save_edit_user?UserID={{$User->id}}&path_file={{$User->Filename}}" name="frmEdit" method="post" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-xs-12">
                      ...
                      <label for="txtUserID" class="col-xs-4 control-label ">UserID</label>
                      <div class="col-xs-8 form-group">
  ...
  <footer class="text-center">
    <center><p>Power by 2PM CE@KMITL</p>
