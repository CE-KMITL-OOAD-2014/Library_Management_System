...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <title>เพิ่มจำนวนหนังสือ - ระบบจัดการห้องสมุด (Library Management System)</title>
      ...
      <div class="row">
        ...
        <div class="col-xs-10">
          <div class="row">
            ...
            <div class="col-xs-8">
              <center><strong><h1>ใส่จำนวนหนังสือที่มีอยู่</h1></strong></center>
              <form action="add_book?BookID={{$Book->id}}" name="frmEdit" method="post">
                <div class="panel panel-info">
                  <div class="panel-heading"><strong>Add Books</strong></div>
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-xs-12">
                        <label for="txtUserBorrow" class="col-xs-4 control-label">Number of books</label>
                        <div class="col-xs-8 form-group">
                          <input name="txtNumBook" type="text" class="form-control" id="txtNumBook" placeholder="Number of Books" required autofocus>
                        </div>
