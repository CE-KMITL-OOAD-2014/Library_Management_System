...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <title>รายการการจองหนังสือของผู้ใช้งาน - ระบบจัดการห้องสมุด (Library Management System)</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-xs-10">
          <div class="row">
            <div class="col-xs-12">
              <center><strong><h1>รายการการจองหนังสือของผู้ใช้งาน</h1></strong></center>
                <div class="panel panel-info">
                  <div class="panel-heading"><strong>Booking Book Lists Detail</strong></div>
                      ...
                      <div class="col-xs-12">
                        ...
                        <table class="table table-bordered">
                          ...
                          <tr>
                            ...
                            @endif
                            <td align="center"><a href="edit_booking_Date?BookID={{$Book[$i]->id}}">{{$Book[$i]->DateBorrow}}</a></td>
                            <td align="center"><a href="check_cancel_booking?BookID={{$Book[$i]->id}}">Cancel</a></td>
                          </tr>
                          <?php
                          }else break;
                        }
                          ...
                          <strong>Total <?php echo $Num_Rows;?> Record : <?php echo $Num_Pages;?> Page
                            <nav>
                              <ul class="pagination">
                                <?php
                                  if($Prev_Page){
                                    echo " <li><a href='booking_history_list?Page=$Prev_Page'><< Back</a></li> ";
                                  }
                                  for($i=1; $i<=$Num_Pages; $i++){
                                    if($i != $Page){
                                      echo "<a href='booking_history_list?Page=$i'>$i</a></li>";
                                    }else{
                                      echo "<li class='active'><a><b> $i </b></a></li>";
                                    }
                                  }
                                  if($Page!=$Num_Pages){
                                    echo " <a href ='booking_history_list?Page=$Next_Page'>Next>></a></li> ";
                                  }
                                ?>
                              </ul>
                            </nav>
