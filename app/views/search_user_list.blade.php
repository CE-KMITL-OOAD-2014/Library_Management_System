...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <title>รายชื่อผู้ใช้งานที่ได้จากการค้นหา - ระบบจัดการห้องสมุด (Library Management System)</title>
      ...
      <div class="row">
          ...
          <ul class="list-unstyled">
            <li class="nav-header"> 
              ...
              <ul class="list-unstyled collapse in" id="MenuBook">
                ...
                <li><a href="/book/topchart"><i class="glyphicon glyphicon-search"></i> Top Chart </a></li>
              </ul>
            </li>
            <li class="nav-header"> 
        ...
        <div class="col-xs-10">
          <div class="row">
            ...
            <div class="col-xs-10">
              @if($_GET["txtKeyword"]=="")
              <center><strong><h1>รายชื่อผู้ใช้งานทั้งหมด</h1></strong></center>
              @else
              <center><strong><h1>รายชื่อผู้ใช้งานที่ได้จากการค้นหา : {{$_GET["txtKeyword"]}}</h1></strong></center>
              @endif
                      ...
                      <div class="col-xs-12">
                        ...
                        <table class="table table-bordered">
                          <tr class="warning">
                            ...
                            <th width="50"> <div align="center">Fine </div></th>
                            <th width="60"> <div align="center">PayFine </div></th>
                          ...
                          <strong>Total <?php echo $Num_Rows;?> Record : <?php echo $Num_Pages;?> Page
                            <nav>
                              <ul class="pagination">
                                <?php
                                  if($Prev_Page){
                                    echo " <li><a href='search_user_list?Page=$Prev_Page&txtKeyword=$_GET[txtKeyword]'><< Back</a></li> ";
                                  }
                                  for($i=1; $i<=$Num_Pages; $i++){
                                    if($i != $Page){
                                      echo "<li><a href='search_user_list?Page=$i&txtKeyword=$_GET[txtKeyword]'>$i</a></li>";
                                    }else{
                                      echo "<li class='active'><a><b> $i </b></a></li>";
                                    }
                                  }
                                  if($Page!=$Num_Pages){
                                    echo " <li><a href ='search_user_list?Page=$Next_Page&txtKeyword=$_GET[txtKeyword]'>Next>></a></li> ";
                                  }
                                ?>
                              </ul>
                            </nav>
