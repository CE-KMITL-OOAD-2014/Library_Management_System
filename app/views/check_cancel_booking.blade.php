...
<head>
  ...
  <meta charset="utf-8">
  <title>ยกเลิกการจองหนังสือ</title>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xs-6 col-md-8">
            <center><strong><h1>Cancel Booking Book : {{$Book->Title1}}</h1></strong></center>
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-xs-6 col-md-12">
                        ...
                        <label  class="col-md-4 control-label">Do you want Cancel Booking?</label>
