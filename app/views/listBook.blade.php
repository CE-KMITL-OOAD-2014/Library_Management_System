...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <title>รายชื่อหนังสือทั้งหมด - ระบบจัดการห้องสมุด (Library Management System)</title>
                      ...
                      <div class="col-xs-12">
                        ...
                        <table class="table table-bordered">
                          <tr class="warning">
                            ...
                            <th width="100">
                              <div align="center">Delete <input name="CheckAll" type="checkbox" id="CheckAll" value="Y" onClick="ClickCheckAll(this);"></div>
                            </th>
                          </tr>
                        ...
                        <center>
                          <strong>Total <?php echo $Num_Rows;?> Record : <?php echo $Num_Pages;?> Page
                            <nav>
                              ...
                              <?php
                                if($Prev_Page){
                                  echo " <li><a href='list_book?Page=$Prev_Page'><< Back</a></li> ";
                                }
                                for($i=1; $i<=$Num_Pages; $i++){
                                  if($i != $Page){
                                    echo "<li><a href='list_book?Page=$i'>$i</a></li>";
                                  }else{
                                    echo "<li class='active'><a><b> $i </b></a></li>";
                                  }
                                }
                                if($Page!=$Num_Pages){
                                  echo " <li><a href ='list_book?Page=$Next_Page'>Next>></a></li> ";
                                }
                              ?>
                              </ul>
                            </nav>
